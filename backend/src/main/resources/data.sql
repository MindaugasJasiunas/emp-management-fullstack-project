...
VALUES (1, 'e1849a7d-ec51-46a7-8afc-ec2a77e00bd6', 'johnd', 'John', 'Doe', 'password', 'johnd@example.com', 'https://avatars.dicebear.com/api/adventurer/q.svg', '2022-06-01', '2022-06-01', '1990-01-01', true, true);

INSERT INTO user_entity (id, public_id, username, first_name, last_name, password, email, profile_image_url, join_date, last_login_date, date_of_birth, is_active, is_not_locked)
VALUES (2, 'e2d4b3af-595c-4462-ac3e-74ee0eb33dd4', 'janed', 'Jane', 'Doe', 'password', 'janed@example.com', 'https://avatars.dicebear.com/api/adventurer/qw.svg', '2027-09-25', '2022-05-10', '1996-07-15', true, true);

INSERT INTO user_entity (id, public_id, username, first_name, last_name, password, email, profile_image_url, join_date, last_login_date, date_of_birth, is_active, is_not_locked)
VALUES (3, 'e2d4b3af-595c-4462-ac3e-74ee0eb33dd4', 'karen', 'Karen', 'Mngr', 'password', 'karen@example.com', 'https://avatars.dicebear.com/api/adventurer/qwe.svg', '2010-01-01', '2022-06-08', '1980-07-15', true, true);

INSERT INTO user_entity (id, public_id, username, first_name, last_name, password, email, profile_image_url, join_date, last_login_date, date_of_birth, is_active, is_not_locked)
VALUES (4, 'e2d4b3af-595c-4462-ac3e-74ee0eb33dd4', 'admin', 'Admin', 'App', 'password', 'admin@example.com', 'https://avatars.dicebear.com/api/adventurer/qwer.svg', '2009-01-01', '2022-06-14', '1994-02-14', true, true);
